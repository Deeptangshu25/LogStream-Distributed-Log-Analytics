...
public final class LogSearchEngine implements SearchService, AutoCloseable {
     ...
     * The shared IndexManager bean is injected here.
     */
    @Autowired
    ...
    /*
     * Kept for unit tests and manual construction.
     */
    public LogSearchEngine(
        ...
        this.queryParserService = Objects.requireNonNull(
                queryParserService,
                "queryParserService must not be null");
    }
    ...
    private static void addTimeFilter(
            BooleanQuery.Builder builder,
            Instant start,
            Instant end) {
